...
@st.cache_data
def read_pdf_data(st_file_obj, run_id: Optional[str] = None):
    return process_pdf_file(st_file_obj, run_id=run_id)
...
if df is not None and data and not (df and df.strip()):
